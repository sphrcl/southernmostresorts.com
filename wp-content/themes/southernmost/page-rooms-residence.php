			...
			<div class="post-meta-area">
				...
				<div class="socialmedia">
					<ul>
						...
						<?php if(get_option('misfit_twitter')) { ?><li><a href="<?php echo get_option('misfit_twitter'); ?>" target="_blank" aria-label="link to southernmost tiwtter page"><i class="fa fa-twitter"></i></a></li><?php } ?>
