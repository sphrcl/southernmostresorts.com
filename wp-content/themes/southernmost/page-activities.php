			...
			<div class="post-meta-area">
				...
				<div class="socialmedia">
					<ul>
						...
						<?php if(get_option('misfit_twitter')) { ?><li><a href="<?php echo get_option('misfit_twitter'); ?>" target="_blank"><i class="fa fa-twitter" aria-label="link to southernmost twitter page"></i></a></li><?php } ?>
