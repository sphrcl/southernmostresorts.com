			...
			<div class="post-meta-area">
				...
				<div class="socialmedia">
					<ul>
						...
						<?php if(get_option('misfit_twitter')) { ?><li><a href="<?php echo get_option('misfit_twitter'); ?>" target="_blank" aria-label="link to southernmost instagram page"><i class="fa fa-twitter"></i></a></li><?php } ?>
						<?php if(get_option('misfit_youtube')) { ?><li><a href="<?php echo get_option('misfit_youtube'); ?>" target="_blank" aria-label="link to southernmost instagram page"><i class="fa fa-youtube-play"></i></a></li><?php } ?>
