		...
		<div class="container">
			...
			<div class="post-meta-area">
				...
				<div class="socialmedia">
					<ul>
						<?php if(get_option('misfit_facebook')) { ?><li><a href="<?php echo get_option('misfit_facebook'); ?>" target="_blank" aria-label="link to southernmost facebok page"><i class="fa fa-facebook"></i></a></li><?php } ?>
